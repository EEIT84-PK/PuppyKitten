...
<header>
			<ul id="header_left">
				<li><img src="<%=request.getContextPath()%>/images/smalllogo.png" width="20px" /></li>
		...
		<div id="menu">
			...
			<ul id="header_right">
				...
				<a class="facebook" href="https://www.facebook.com/%E7%B1%B3%E6%B2%83%E8%B2%93%E7%AA%A9-150232665031651/?fref=ts">
				<img src="<%=request.getContextPath()%>/images/css/facebook.png" /></a></li>
				<li><a href="">聯絡我們<img src="<%=request.getContextPath()%>/images/phone.png" width="15px"></a></li>
				<li><a href="">購物車<img src="<%=request.getContextPath()%>/images/cart.png" width="15px"></a></li>
				<li><a href="">會員中心</a></li>
				<li><a href="">註冊</a></li>
				<li><a href="">登入</a></li>	
			</ul>
