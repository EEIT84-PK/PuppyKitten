...
<body>
	...
	<section>
		...
		<article style="width: 1500px; background-color: white;">
			...
			商品編號：<input type="text" name="pro_id"><br><br>
				商品類型：<select name="pro_animal">
					<option>汪星人</option>
					<option>喵星人</option>
				</select><br>
				<br> 商品種類：<select name="pro_kind">
					<option>主食乾糧</option>
					<option>外出專用</option>
					<option>精選罐頭</option>
					<option>嚴選零嘴</option>
				...
				<br> 商品名稱：<input type="text" name="pro_name"><br>
				<br> 優惠方案：<select name="pro_project">
					<option>指定價格</option>
					<option>買X送X</option>
					<option>指定折扣</option>
				</select><br>
				<br> 商品重量：<input type="text" name="pro_weight"><br>
				...
				<br> 商品介紹：<input type="text" name="pro_body"><br>
				<table>
				<tr>
				...
				<br> <input type="submit" value="重新上架">
